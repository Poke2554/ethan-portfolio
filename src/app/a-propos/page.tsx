    ...
    <div className="bg-white">
        ...
        <div className="page-shell pb-20 md:pb-28">
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-7">
              <p className="text-[11px] uppercase tracking-[0.45em] text-muted">02 — À propos</p>
              <h1 className="mt-6 font-display text-[clamp(3rem,10vw,6.5rem)] font-semibold uppercase leading-[0.92] tracking-[-0.04em]">
                {siteConfig.name}
              </h1>
              <p className="mt-6 max-w-md text-sm uppercase tracking-[0.28em] text-muted">
                {siteConfig.role}
              </p>
            </div>
            <div className="flex flex-col justify-end lg:col-span-5">
              <p className="text-base leading-8 text-foreground md:text-lg">{aboutContent.intro}</p>
              <p className="mt-6 text-sm leading-8 text-muted">{aboutContent.bio}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="grid lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center border-t border-border px-6 py-16 md:px-10 lg:border-t-0 lg:border-l lg:py-24">
          <p className="text-[11px] uppercase tracking-[0.4em] text-muted">Ce que je fais</p>
        ...
        <div className="page-shell py-20 md:py-28">
          <div className="grid gap-12 lg:grid-cols-12 lg:items-end">
            <div className="lg:col-span-6">
              <p className="text-[11px] uppercase tracking-[0.45em] text-background/50">Contact</p>
              ...
              <p className="mt-6 max-w-lg text-sm leading-7 text-background/70">
                Pour un projet photo, une captation vidéo ou une collaboration, écrivez-moi
            ...
            <div className="space-y-8 lg:col-span-6">
              <div className="border-t border-background/20 pt-8">
                <p className="text-[10px] uppercase tracking-[0.28em] text-background/45">Email</p>
                <a
